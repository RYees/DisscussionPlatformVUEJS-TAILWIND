<template>
  ...
  >
    ...
    >
      <div class="w-11/12">
        <div
          class="shadow bg-yellow-500 bg-opacity-95 h-20 w-full"
        ...
        >
          ...
          <h3
            style="padding:15px;"
            class="shadow flex justify-center bg-yellow-500 bg-opacity-75 h-20  text-white text-xl flex-1 transform capitalize"
          >
            {{ flashMessage }}
          </h3>
        </div>
        <h1
          class="text-gray-600 text-center tracking-wider text-4xl ml-2 h-16"
          style="margin-top:10px"
        >
          Login
        </h1>
        ...
        <div>
          ...
          />
          <span
            class="text-red-500 text-sm transform capitalize"
            v-if="errorEmail"
            >{{ errorEmail }}</span
          >
          <br />
          ...
          <div
            class="text-red-500 text-sm transform capitalize"
            v-if="login.password.length > 1 && login.password.length < 6"
          >
